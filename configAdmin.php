    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">Free Market</small></h1>
            </div>
            <!-- Nav tabs -->
                                                  ...
                                                  <form method="post" action="process/updateProduct.php" id="res-update-product-'.$upr.'">
                                                    <tr>
                                                      ...
                                                      echo '</select>
                                                        ...
                                                        <td>';
                                                           $proveedoresc3=  ejecutarSQL::consultar("select * from proveedor where RFC='".$prod['RFC']."'");
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div id="add-provee">
                            ...
                            <form action="process/regprove.php" method="post" role="form">
                                <div class="form-group">
                                    <label>RFC</label>
                                    <input class="form-control" type="text" name="prove-rfc" placeholder="RFC proveedor" maxlength="30" required="">
                                </div>
                                <div class="form-group">
                                    <label>Nombre</label>
                        ...
                        <div id="del-prove">
                            ...
                            <form action="process/delprove.php" method="post" role="form">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="rfc-prove">
                                        <?php 
                                            $proveRFC=  ejecutarSQL::consultar("select * from proveedor");
                                            while($PN=mysqli_fetch_array($proveRFC)){
                                                  ...
                                                  echo '
                                                      <div id="update-proveedor">
                                                        <form method="post" action="process/updateProveedor.php" id="res-update-prove-'.$up.'">
                                                          <tr>
                                                              <td>
                                                                <input class="form-control" type="hidden" name="rfc-prove-old" required="" value="'.$prov['RFCProveedor'].'">
